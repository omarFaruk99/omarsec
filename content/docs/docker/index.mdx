...
|---------|-----------------|
| [What is Docker](/docs/docker/what-is-docker) | The problem Docker solves, containers vs virtual machines |
| [Installation](/docs/docker/installation) | Installing Docker on Windows (WSL2), macOS, or Linux |
| [Core Concepts](/docs/docker/core-concepts) | Image, container, and registry — the three ideas everything else builds on |
| [Your First Container](/docs/docker/first-container) | Running, stopping, and removing a container |
| [Essential Commands](/docs/docker/essential-commands) | The commands you will use every day |

<Callout type="default">
More sections will be added as this guide grows: building your own images, volumes and networking, Docker Compose with a full stack, and production deployment.
</Callout>
