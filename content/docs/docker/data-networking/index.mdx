...
<Callout type="info">
Foundation warned you that a removed container loses everything inside it. This section fixes that, and covers the two other things every real app needs: talking to other containers, and reading configuration that changes per environment.
</Callout>
