...
server {
    ...
    location / {
        ...
        # HTTP না HTTPS — সেটি অ্যাপকে জানাও
        proxy_set_header X-Forwarded-Proto $scheme;

        # WebSocket connection কাজ করার জন্য
...
এখন আপনার browser থেকে `http://YOUR_SERVER_IP` visit করুন।

<Callout type="info">
  আপনি এখন **502 Bad Gateway** দেখবেন — এবং এটাই এই মুহূর্তে **সঠিক ফলাফল**।

  502-এর অর্থ হলো Nginx ঠিকমতো কাজ করছে, request গ্রহণ করছে এবং সেটি `localhost:3000`-এ পাঠানোর চেষ্টা করছে — কিন্তু ওখানে এখনো কোনো app চলছে না। অর্থাৎ আপনার config সঠিক।

  পরের page-গুলোতে code আনা, `.env` তৈরি করা এবং PM2 দিয়ে app চালু করার পর এই 502 চলে যাবে এবং আপনার site দেখা যাবে।
</Callout>

<Callout type="warning">
  যদি 502-এর বদলে **connection timeout** আসে বা কিছুই না আসে, তাহলে সমস্যা অন্য জায়গায় — firewall। `sudo ufw status` দিয়ে port 80 open আছে কিনা দেখুন। AWS ব্যবহার করলে Security Group-ও check করুন।
</Callout>
...
- [ ] `http://YOUR_SERVER_IP` visit করলে **502 Bad Gateway** দেখাচ্ছে? (এই ধাপে এটাই সঠিক)

**পরবর্তী →** [SSL & HTTPS](/docs/server-deployment/foundation/ssl-https)
