...
Browser-এ `https://yourdomain.com` visit করুন। URL bar-এ **তালার চিহ্ন (padlock icon)** দেখলে SSL সফলভাবে বসেছে।

<Callout type="info">
  Padlock দেখা যাচ্ছে কিন্তু পাতায় **502 Bad Gateway** লেখা — এটাই এখন সঠিক অবস্থা।

  Padlock মানে HTTPS কাজ করছে (certificate ঠিক আছে), আর 502 মানে app এখনো চালু হয়নি। App চালু হবে PM2 page-এ। তখন 502 চলে যাবে।
</Callout>
...
- [ ] `https://yourdomain.com` browser-এ padlock দেখাচ্ছে? (পাতায় 502 থাকলেও ঠিক আছে)
- [ ] `http://` দিয়ে গেলে `https://`-এ redirect হচ্ছে?
- [ ] `sudo certbot renew --dry-run` সফল হচ্ছে?

**পরবর্তী →** [GitHub Setup](/docs/server-deployment/foundation/github-setup)
