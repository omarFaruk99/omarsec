...
<Callout type="info">
  **`chmod 600` কী করে?** এটি file-এর permission এমনভাবে সেট করে যে শুধু file-এর owner (আপনার `ubuntu` user) পড়তে এবং লিখতে পারবে। অন্য কোনো user এই file দেখতে পারবে না।
