...
<Callout type="default">
  AWS-এ আপনি `ubuntu` user হিসেবে আছেন যার `sudo` access আছে — সরাসরি root নন। পরের page-এ আমরা একটি dedicated `aladin` user তৈরি করব উভয় provider-এর জন্য।
</Callout>
...
<span style={{ display: 'none' }}>
  contabo server setup bangla, aws ec2 free tier bangla, vps vs cloud bangla, ubuntu server create, server deploy bangla, vps provider comparison bangla, aws ec2 ubuntu login, server aladin user bangla
</span>
