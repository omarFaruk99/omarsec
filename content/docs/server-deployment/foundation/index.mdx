...
<FileTree>
  <FileTree.Folder name="Your Server (Ubuntu 24.04 LTS)" defaultOpen>
    ...
    <FileTree.Folder name="/home/aladin/myapp">
...
### Install Node.js
Git এবং NVM দিয়ে Node.js install করুন — বাকি সব step-এর জন্য এটি দরকার।
...
### Connect to GitHub
Server-কে GitHub-এর সাথে যুক্ত করুন এবং code clone করুন।

### Configure Environment Variables
Server-এ `.env` file তৈরি করুন।

### Set Up PM2
App build করুন, PM2 দিয়ে চালু করুন এবং auto-restart configure করুন।

### Deploy Your First App
পুরো প্রক্রিয়ার একটি সংক্ষিপ্ত checklist — শুরু থেকে শেষ পর্যন্ত।
...
**পরবর্তী →** [Choose a Server](/docs/server-deployment/foundation/choose-server)
