...
<Callout type="warning">
  React-এর ক্ষেত্রে প্রোজেক্টটি `/home/ubuntu` এর বদলে `/var/www/myapp` ফোল্ডারে রাখুন। এতে Nginx সরাসরি ফাইলগুলো পড়ার অনুমতি পাবে এবং আপনি **403 Forbidden** সমস্যা থেকে রক্ষা পাবেন।
</Callout>
