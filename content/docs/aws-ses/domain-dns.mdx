...
| Checkbox | কেন skip |
|---|---|
| **Assign a default configuration set** | event tracking (open/click/bounce)-এর advanced ফিচার, পরে [Bounce and Complaint Notifications](/docs/aws-ses/bounce-complaint-notifications)-এ আলাদাভাবে যোগ করা যায় |
