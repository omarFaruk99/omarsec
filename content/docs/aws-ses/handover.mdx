...
- Production access পাওয়া গেছে কনফার্ম, সাথে Maximum send rate ও Daily sending quota সংখ্যা
...
- Bounce/Complaint notification কোন ইমেইলে আসবে সেটা জানিয়ে দিন — default-এ যে ঠিকানা থেকে মেইল পাঠানো হয়, সেখানেই আসে ([Bounce and Complaint Notifications](/docs/aws-ses/bounce-complaint-notifications)-এ বিস্তারিত)
