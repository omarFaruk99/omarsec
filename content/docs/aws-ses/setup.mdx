...
SES কনসোল → বামের সাইডবারে **SMTP settings** → **Create SMTP credentials** → username দিন (default রাখা যায়) → **Create**।

- `SMTP username` + `SMTP password` দেখাবে — সেভ করুন (একবারই দেখাবে)।
- SMTP endpoint দেখাবে যেমন `email-smtp.ap-southeast-1.amazonaws.com`, port `587`।
