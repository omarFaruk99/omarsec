...
**প্রথমে একটি সিদ্ধান্ত — package private রাখবেন, নাকি public করবেন?**
...
<Callout type="default">
  **কখন public করা নিরাপদ:** আপনার site যদি এমনিতেই সবার জন্য খোলা থাকে — documentation, blog, portfolio — তাহলে image-এ যা আছে তা তো browser-এ সবাই দেখছেই। তখন public করলে সীমার ঝামেলা থাকে না।

  **কখন নয়:** client-এর app, ভেতরে business logic আছে এমন কিছু, বা যেকোনো private product। তখন private রাখুন আর নিচের token পদ্ধতি ব্যবহার করুন।

  Package তৈরিই হবে **প্রথম push-এর পরে**। তাই visibility বদলাতে হলে প্রথম deploy সফল হওয়ার পরে করবেন:
  `GitHub → আপনার profile → Packages → package-টি → Package settings → Change visibility`
</Callout>

Public করলে নিচের ধাপগুলো বাদ দিন — server-কে কিছু করতে হবে না।

Private রাখলে একটি token লাগবে। GitHub-এ গিয়ে বানান:
