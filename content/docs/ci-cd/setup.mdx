...
```bash filename="LOCAL — Terminal"
cat ~/.ssh/gh_actions.pub | ssh USER@YOUR_SERVER_IP "mkdir -p ~/.ssh && cat >> ~/.ssh/authorized_keys"
```
...
### Test the Key the Way Actions Will Use It

এই ধাপটি ছোট দেখাচ্ছে, কিন্তু **সবচেয়ে বেশি pipeline এখানেই fail করে**। তাই এটি মন দিয়ে করুন।
...
## Two Things That Silently Break Pipelines

দুটি সমস্যা খুব সাধারণ কিন্তু কোথাও লেখা থাকে না।
...
এখন port 22 সবার জন্য খোলা থাকলেও key ছাড়া কেউ ঢুকতে পারবে না।
...
<Callout type="warning">
  **আপনার pipeline এখন server-এর একটি চাবি ধরে আছে।**
  ...
  একটি সহজ test: আপনার repository-তে যাদের write access আছে তাদের list দেখুন। ওই সবার হাতেই এখন আপনার production server আছে।
</Callout>
