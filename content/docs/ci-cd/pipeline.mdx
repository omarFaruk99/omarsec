...
ফল হাতেনাতে — সাধারণ Next.js image প্রায় ১ GB, standalone দিয়ে সেটি ১৫০ MB-র কাছাকাছি নেমে আসে। প্রতিবার deploy-এ server-কে এই image টানতে হয়, তাই ছোট image মানে দ্রুত deploy আর কম bandwidth।
...
<Callout type="info">
  **প্রথমবার `deploy` job fail করতে পারে, আর সেটা স্বাভাবিক।**

  Package public করবেন ঠিক করে থাকলে এখনো সেটি private অবস্থায় আছে, কারণ package তৈরিই হলো এইমাত্র। Server তাই টানতে পারবে না:

  ```
  Error response from daemon: error from registry: unauthorized
  ```

  এখন package-টি তৈরি হয়ে গেছে। GitHub-এ গিয়ে সেটিকে public করুন, তারপর Actions-এ **Re-run failed jobs** চাপুন। এবার চলবে।
</Callout>
...
`Up` না দেখালে, বা `Restarting` দেখালে — container-এর ভেতরে কী হচ্ছে দেখুন:
