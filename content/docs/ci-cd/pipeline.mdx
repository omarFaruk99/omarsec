...
শুরুতেই পরিষ্কার করে নিই কোন file কোথায় থাকবে। এই ছবিটি মাথায় থাকলে বাকিটা সহজ।
      ...
      - name: Deploy to server
        ...
        with:
          ...
          script: |
            ...
            # এখানে পৌঁছানো মানে app উঠল না — ফিরে যাই
...
কারণটি সহজ: GitHub-এর সবুজ checkmark-এর মানে শুধু "সব command exit code 0 দিয়েছে"। `docker compose up -d` container চালু করেই ফিরে আসে — container-টি ভেতরে গিয়ে crash করল কিনা সে জানে না।
