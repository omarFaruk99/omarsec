...
Script-এর চারটি অংশের ব্যাখ্যা দরকার।
...
Private রাখলে তিনটি কাজ করুন:

- **`node:20-alpine` ব্যবহার করুন**, `node:20` নয়। সাধারণটি প্রায় ১ GB, alpine ১৫০ MB-র কাছাকাছি
- **পুরোনো version মুছুন** — GitHub-এ package-এর পাতায় retention rule বসান। শেষ ১০-১৫টি রাখলেই যথেষ্ট
- চিন্তা কম করুন — **layer share হয়**। ২০টি tag মানে ২০ × ১৫০ MB নয়, শুধু বদলানো অংশটুকু নতুন করে জমা হয়
