...
<Callout type="warning">
  **Third-party action মানে অন্যের code আপনার pipeline-এ চলছে।**
  ...
  এটি একটি সত্যিকারের attack path। ২০২৫ সালের ১৪ মার্চ `tj-actions/changed-files` নামের একটি action-এ ঠিক এই ঘটনা ঘটে। Action-টি ২৩,০০০-এরও বেশি repository ব্যবহার করত। Attacker ভেতরে একটি malicious script ঢুকিয়ে দেয় যা runner-এর memory থেকে secrets টেনে build log-এ ছেপে দিত। Public repository-র log সবাই পড়তে পারে, তাই সেগুলোর secrets প্রকাশ্যে চলে আসে।
