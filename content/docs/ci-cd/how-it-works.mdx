...
[Docker](/docs/docker/multi-container/the-full-stack) section-এ আপনি `compose.yaml` দেখেছেন code-এর পাশে, project-এর root folder-এ। এই section-এ সেটি থাকবে server-এ, একা।
...
<Callout type="warning">
  ...
  Server    →  RUN করে     →  লাগে: compose.yaml + .env   (code নেই)
  ```
