...
export const metadata = {
  title: {
    default: 'OmarSec — Exploring Offensive Security',
    template: '%s | OmarSec',
  },
  description:
    'Documenting the journey through offensive security and penetration testing. Open-source notes, hacking techniques, and infrastructure research.',
  openGraph: {
    title: 'OmarSec',
    description: 'Documenting the journey through offensive security and penetration testing. Open-source notes, hacking techniques, and infrastructure research.',
    siteName: 'OmarSec',
    type: 'website',
  },
}
...
const navbar = (
  <Navbar
    logo={<span style={{ fontWeight: 800, fontSize: '1.1rem' }}>OmarSec</span>}
